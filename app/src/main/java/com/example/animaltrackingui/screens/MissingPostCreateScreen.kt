...
fun MissingPostCreateScreen(
    ...
    createPostViewModel.onPostTypeChanged(PostType.MISSING)
    ...
    Scaffold(
        ...
        content = { paddingValues ->
            Column(
                ...
                CustomTextField(
                    fieldValue = uiState.value.animalName,
                    fieldLabel = "Animal Name",
                    icon = R.drawable.name_small,
                    onFieldValueChanged = { createPostViewModel.onAnimalNameChange(it) }
                )
                CustomTextField(
                    fieldValue = uiState.value.animalAge,
                    fieldLabel = "Animal Age",
                    icon = R.drawable.calendar_small,
                    onFieldValueChanged = { createPostViewModel.onAnimalAgeChange(it) },
                    keyboardType = KeyboardType.Number
                )
                CustomTextField(
                    fieldValue = uiState.value.contactInfo,
                    fieldLabel = "Contact Information",
                    icon = R.drawable.contact_small,
                    onFieldValueChanged = { createPostViewModel.onContactInfoChange(it) }
                )
                CustomTextField(
    ...
    UploadConfirmationDialog(
        ...
        uploadCallback = {
            createPostViewModel.uploadMissingPost(
                context,
                navController
            )
        },
